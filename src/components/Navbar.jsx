    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-100 bg-white relative transition-all">
            ...
            >
                ...
                <NavLink href="/products" className="block">
                    All Products
                </NavLink>
                <NavLink to="/contact" className="block">
                    Contact
                </NavLink>
                <button className="cursor-pointer px-6 py-2 mt-2 bg-primary hover:bg-primary-dull transition text-white rounded-xl text-sm">
                    Login
                </button>
            </div>
        </nav>
